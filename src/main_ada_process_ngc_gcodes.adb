...
with pkg10_standardize_gcode_to_ngc;
with pkg20_classify_each_gcode_line;
...
is 
   ...
   package PSGTN    renames pkg10_standardize_gcode_to_ngc;
   package PCEGL    renames pkg20_classify_each_gcode_line;
...
begin
   ...
   -- USE (GENERATED BY GCODETOOLS FROM INKSCAPE.)
   -- PACKAGE10 -- STANDARDIZE GCODE TO NGC FORMATTED FILES
